...
// spring drops database before each test method
...
//    private int port;
    ...
    private static final DevDojoUser USER = DevDojoUser.builder()
            ...
            .password("{bcrypt}$2a$10$q/qiDLeelNwftdEuv2qDgO0i9JwjxRueUB6kn0E1NmXwuEf1x7ThO")
            .username("devdojo")
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessul() {
